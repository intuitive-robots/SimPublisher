...
from libero_example import pick_one_bddl_file
...
if __name__ == "__main__":
    ...
    bddl_file = pick_one_bddl_file(args.datasets, args.task_id)
    ...
    while i < args.num_demonstration:
        ...
        if saving:
            ...
            #     tmp_directory, new_dir, env_info, bddl_file, remove_directory
            # )
            i += 1
